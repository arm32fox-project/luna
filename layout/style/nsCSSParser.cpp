...
protected:
  ...
  // For "flex" shorthand property, defined in CSS3 Flexbox spec
  bool ParseFlex();
  // For "flex-flow" shorthand property, defined in CSS3 Flexbox spec
  bool ParseFlexFlow();
...
CSSParserImpl::ParseFlexFlow()
{
  ...
  // Bail if we didn't successfully parse anything, or if there's
  // trailing stuff that shouldn't be there.
