...
public final class GoannaProfile {
    ...
    private static HashMap<String, GoannaProfile> sProfileCache = new HashMap<String, GoannaProfile>();
    ...
    public static GoannaProfile get(Context context) {
        if (context instanceof GoannaApp)
            return get(context, ((GoannaApp)context).getDefaultProfileName());
    ...
    public static GoannaProfile get(Context context, String profileName, String profilePath) {
        ...
        if (TextUtils.isEmpty(profileName) && TextUtils.isEmpty(profilePath)) {
            profileName = GoannaProfile.findDefaultProfile(context);
            if (profileName == null)
                profileName = "default";
        }
        ...
        synchronized (sProfileCache) {
            GoannaProfile profile = sProfileCache.get(profileName);
            if (profile == null) {
                profile = new GoannaProfile(context, profileName, profilePath);
    ...
    public static boolean removeProfile(Context context, String profileName) {
        return new GoannaProfile(context, profileName).remove();
    }

    private GoannaProfile(Context context, String profileName) {
        mContext = context;
        mName = profileName;
    }

    private GoannaProfile(Context context, String profileName, String profilePath) {
        mContext = context;
        mName = profileName;
        setDir(profilePath);
    }
