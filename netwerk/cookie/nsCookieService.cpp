                                   ...
                                   nsIChannel                    *aChannel)
{
  ...
  // XXX: For now we allow 0x20 (Space) and 0x22 (DQUOTE); the former for web
  // compatibility and the latter because DQUOTE *cookie-octet DQUOTE is 
  // permitted and would otherwise fail on the latter. This needs better
  // checking for first and last character allowed DQUOTE bot not in the actual
  // value.
  //
